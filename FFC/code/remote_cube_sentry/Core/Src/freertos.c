...
osThreadId feedforward_TaskHandle;
...
void MX_FREERTOS_Init(void) {
    ...
    osThreadDef(FFCTask, FeedForwardControll_task, osPriorityNormal, 0, 128);
    feedforward_TaskHandle = osThreadCreate(osThread(FFCTask), NULL);
...
__weak void FeedForwardControll_task(void const * argument)
{
    /* USER CODE BEGIN gimbal_task */
    /* Infinite loop */
    for(;;)
